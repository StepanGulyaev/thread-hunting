...
Codename:  n/a
```
В результате выполнения данной команды было определён используемый дистрибутив - Gentoo.
...
В результате выполнения данной команды была получена версия ядра - Linux 6.1.19-gentoo x86_64.
...
Используемый процессор - Intel(R) Core(TM) i5-10600K с тактовой частотой 2.00GHz.


## Оценка результата

В результате лабораторной работы мы получили информацию об используемой системе.
